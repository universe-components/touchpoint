...
Note: TPP allows developers to define custom operator types. For details, please refer to the [Operator Interface](../../../../blob/master/touchpoint-protocol/src/main/java/com/universe/touchpoint/layer/Operator.java).