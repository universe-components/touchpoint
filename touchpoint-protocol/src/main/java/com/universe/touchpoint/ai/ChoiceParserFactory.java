...
public class ChoiceParserFactory {
  ...
  private static final Map<AIModelType, Class<? extends ChoiceParser<?>>> choiceParserMap =
      new HashMap<>();
      ...
      if (choiceParser == null) {
        try {
          ...
          throw new IllegalArgumentException(
              "Error creating choice parser for type: " + modelType, e);
        }
      }
      return (ChoiceParser<CH>) choiceParser;
    }
  }
}
