...
public class Anthropic
    extends AIModel<AnthropicClient, String, CompletionService, Map<Completion, String>> {

  static {
    modelConfigMap.put(
        com.universe.touchpoint.config.ai.Model.ClAUDE_3_5_SONNET,
        com.anthropic.models.Model.CLAUDE_3_5_SONNET_LATEST);
  }

  public Anthropic(LangModelConfig modelConfig) {
    super(AnthropicOkHttpClient.builder().apiKey(modelConfig.getApiKey()).build(), modelConfig);
  }
