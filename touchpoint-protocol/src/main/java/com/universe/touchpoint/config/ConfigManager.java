...
public class ConfigManager {
  ...
  public static LangModelConfig selectModel(String input, AgentActionMeta actionMeta, String task) {
    ...
    LangModelConfig modelFromTask =
        ((MetaRegion) TouchPointMemory.getRegion(Region.META)).getTouchPointTask(task).getModel();
    ...
    AgentMeta agentMeta =
        ((MetaRegion) TouchPointMemory.getRegion(Region.META))
            .getTouchPointAgent(actionMeta.getAgentName());
  ...
  public static VisionModelConfig selectVisionModel(
      String input, AgentActionMeta actionMeta, String task) {
    // 首先检查 action 中的模型
    if (actionMeta != null) {
    ...
    VisionModelConfig modelFromTask =
        ((MetaRegion) TouchPointMemory.getRegion(Region.META))
            .getTouchPointTask(task)
            .getVisionModel();
    if (modelFromTask != null) {
      return modelFromTask;
    }
  ...
  public static VisionLangModelConfig selectVisionLangModel(
      String input, AgentActionMeta actionMeta, String task) {
    // 首先检查 action 中的模型
    if (actionMeta != null) {
    ...
    VisionLangModelConfig modelFromTask =
        ((MetaRegion) TouchPointMemory.getRegion(Region.META))
            .getTouchPointTask(task)
            .getVisionLangModel();
    if (modelFromTask != null) {
  ...
  public static <C> TransportConfig<C> selectTransport(String action, String task) {
    ...
    TransportConfig<?> transportConfigFromTask =
        ((MetaRegion) TouchPointMemory.getRegion(Region.META))
            .getTouchPointTask(task)
            .getTransportConfig();
  ...
  public static AgentSocketConfig selectAgentSocket(String task) {
    AgentSocketConfig socketConfigFromTask =
        ((MetaRegion) TouchPointMemory.getRegion(Region.META))
            .getTouchPointTask(task)
            .getAgentSocketConfig();
  ...
  public static MetricSocketConfig selectMetricSocket(String task) {
    MetricSocketConfig socketConfigFromTask =
        ((MetaRegion) TouchPointMemory.getRegion(Region.META))
            .getTouchPointTask(task)
            .getMetricSocketConfig();
    if (socketConfigFromTask != null) {
      return socketConfigFromTask;
    }
  ...
  public static TaskMetricConfig selectTaskMetricConfig(String task) {
    TaskMetricConfig taskMetricConfigFromTask =
        ((MetaRegion) TouchPointMemory.getRegion(Region.META))
            .getTouchPointTask(task)
            .getTaskMetricConfig();
  ...
  public static ActionMetricConfig selectActionMetricConfig(String action, String task) {
    ...
    ActionMetricConfig actionMetricConfigFromTask =
        ((MetaRegion) TouchPointMemory.getRegion(Region.META))
            .getTouchPointTask(task)
            .getActionMetricConfig();
