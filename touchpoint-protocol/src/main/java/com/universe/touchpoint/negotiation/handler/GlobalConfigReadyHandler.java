...
public class GlobalConfigReadyHandler<Config, TC>
    implements AgentSocketStateHandler<Map<String, Config>, Boolean> {

  @Override
  public <C extends AgentContext> Boolean onStateChange(
      Map<String, Config> globalConfig, C actionContext, String task) {
    if (globalConfig != null) {
      ...
      TouchPointTransportRegistry<TC> registry =
          (TouchPointTransportRegistry<TC>)
