...
public class AnnotationUtils {
    ...
    for (Annotation annotation : clazz.getAnnotations()) {
      ...
      if (annotation2Config.containsKey(annotationType)) {
        ...
        Object configInstance =
            configInstances.computeIfAbsent(
  ...
  public static Object annotation2Config(
      Class<?> clazz, Map<Class<? extends Annotation>, Class<?>> annotation2Config)
      throws Exception {
    for (Annotation annotation : clazz.getAnnotations()) {
      Class<? extends Annotation> annotationType = annotation.annotationType();
  ...
  public static Map<String, Object> getAnnotationValue(
  ...
  public static Object getAnnotationValue(
      Annotation annotation, Class<? extends Annotation> annotationClass, String propertyName) {
    try {
