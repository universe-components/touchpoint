...
public class AgentTaskRegistrar implements ImportBeanDefinitionRegistrar, EnvironmentAware {
  ...
  public void registerBeanDefinitions(
    ...
    if (importingClassMetadata.hasAnnotation(
        com.universe.touchpoint.annotations.task.Task.class.getName())) {
      String taskClassName = com.universe.touchpoint.annotations.task.Task.class.getName();
      Map<String, Object> taskAttributes =
          importingClassMetadata.getAnnotationAttributes(taskClassName);
      ...
      try {
        ...
        AgentSocketStateMachine.getInstance(taskName)
            .registerReceiver(
